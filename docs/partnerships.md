...
| **GUARD** (W.R. Berkley / WestGUARD) | Carrier / API | **Live** (CO pilot) | ConnectQuote **WC** second line — not a Coterie replacement | Distribution / WC premium | SOAP ACORD + doc webhook (direct bill) | Confirm | Live on ConnectQuote; GUARD direct bill (CID not MoR) — [`guard-integration.md`](./guard-integration.md) | Rick / Gerry |
