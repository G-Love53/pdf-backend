...
| **ConnectQuote WC (GUARD)** | Optional second line on the same submission; **live** (CO pilot) | Main-form WC opt-in → indication → bind; **GUARD bills insured** — [`guard-integration.md`](./guard-integration.md) |
