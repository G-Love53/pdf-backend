...
| 2026-08-27 | **GUARD WC sandbox E2E:** main-form WC opt-in, NBQ indication, NBS/BND, `finalizeGuardBind()` → Connect policy row. Years-in-business prefill from month started. Prod gated on Jon credentials + CO class codes. |
