export default function buildPlumberExtractionPrompt(pdfBase64) {
  return {
    ...
    messages: [
      {
        ...
        content: [
          ...
          {
            type: "text",
            text: `You are extracting structured quote data from a commercial insurance quote PDF for a PLUMBING CONTRACTOR business.
...
- water_damage_sublimit (any stated sublimit for water damage, in dollars)
