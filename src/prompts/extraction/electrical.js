    ...
    messages: [
      {
        ...
        content: [
          ...
          {
            type: "text",
            text: `You are extracting structured quote data from a commercial insurance quote PDF for an ELECTRICAL CONTRACTOR business.
...
Electrical-contractor-specific fields:
...
- completed_operations (true/false)
- subcontractor_coverage (true/false — coverage for subs or hired contractors)
