export default function buildHvacExtractionPrompt(pdfBase64) {
  return {
    ...
    messages: [
      {
        ...
        content: [
          ...
          {
            type: "text",
            text: `You are extracting structured quote data from a commercial insurance quote PDF for an HVAC CONTRACTOR business.
...
- professional_liability (true/false)
- professional_liability_limit (if included, the limit in dollars)
- refrigerant_coverage (true/false — coverage for refrigerant loss/leak)
- pollution_liability (true/false)
- pollution_liability_limit (if included, the limit in dollars)
- tools_equipment_coverage (limit for tools and equipment coverage, in dollars)
