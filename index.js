...
<div class="two-column">
    ...
    <div class="two-column">
        <label>Applicant's Phone Number:<input name="applicant_phone_number" type="text"/></label>
        <label>Web Address:<input name="web_address" type="text"/></label>
    </div>
    
    <div class="two-column">
        <label>Inspection Contact:<input name="inspection_contact" type="text"/></label>
        <label>Phone for Inspection Contact:<input name="phone_Number_for_inspection_contact" type="text"/></label>
    </div>
    
    <div class="two-column">
        <label>Policy Period From:<input name="proposed_policy_period_from" type="date"/></label>
        <label>Policy Period To:<input name="proposed_policy_period_to" type="date"/></label>
    </div>
    ...
    <div class="percentage-grid">
        <label>Flat Roofs %:
            <select name="flat_roofs" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Metal %:
            <select name="metal" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Pitch Roofs %:
            <select name="pitch_roofs" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Asphalt Shingle %:
            <select name="asphalt_shingle" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Single Ply %:
            <select name="single_ply" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Tile %:
            <select name="tile" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Fiberglass %:
            <select name="fiberglass" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Wood %:
            <select name="wood" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Polyurethane Foam %:
            <select name="polyurethane_foam" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Hot Tar %:
            <select name="hot_tar" class="materials-percent" data-conditional="hot_tar_use">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Slate %:
            <select name="slate" class="materials-percent">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
        ...
        <label>Torch Down %:
            <select name="torch_down" class="materials-percent" data-conditional="torch_down_use">
                <option value="">--</option>
                <option value="0">0%</option>
                <option value="10">10%</option>
                <option value="20">20%</option>
    ...
    <div class="two-column">
        ...
        <label>Uninsured Subcontractor Payroll $<input name="Uninsured_Subcontractor_Payroll" type="text"/></label>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function setupConditionalLogic() {
            ...
            const hotTar = document.querySelector('[name="Hot_Tar"]');
            const torchDown = document.querySelector('[name="Torch_Down"]');
        ...
        const currencyInputs = [
            'Owner_Partner_Payroll', 'Subcontractor_Cost', 'Uninsured_Subcontractor_Payroll',
            'Employee_Payroll', 'Leased_Employees_Payroll', 'Total_Gross_Sales', 'Wrap_Up_Cost',
            'Gross_Sales_Year_1', 'Gross_Sales_Year_2', 'Gross_Sales_Year_3',
            'Minimum_Limits'
        ];
