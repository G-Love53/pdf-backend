-- Add beauty, cleaning, and pet ConnectQuote segments.
-- Run on cid-postgres (Render DATABASE_URL for CID-PDF-API).

ALTER TYPE segment_type ADD VALUE IF NOT EXISTS 'beauty';
ALTER TYPE segment_type ADD VALUE IF NOT EXISTS 'cleaning';
ALTER TYPE segment_type ADD VALUE IF NOT EXISTS 'pet';
